                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('Classrooms.update', 'test') }}" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <label for="Name_en"
                                                               class="mr-sm-2">{{ trans('My_Classes_trans.Name_class_ru') }}
                                                            :</label>
                                                        <input type="text" class="form-control"
                                                               value="{{ $My_Class->getTranslation('Name_Class', 'ru') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label for="Name"
                                                class="mr-sm-2">{{ trans('My_Classes_trans.Name_class_ru') }}
                                                :</label>
                                            <input class="form-control" type="text" name="Name_class_ru"  >
                                        </div>
