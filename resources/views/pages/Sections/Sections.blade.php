                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{$list_Sections->MyClasses->Name_Class}} 
                                                                        </td>
                                                                         <td>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       name="Name_Section_Ru"
                                                                                                       class="form-control"
                                                                                                       value="{{ $list_Sections->getTranslation('Name_Section', 'ru') }}">
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Class_id"
                                                                                                    class="custom-select">
                                                                                                <option
                                                                                                    value="{{ $list_Sections->MyClasses->id }}">
                                                                                                    {{ $list_Sections->MyClasses->Name_Class }}
                                                                                                </option>
                                                                                            </select>
                                                                                        </div>
                                                                                        <br>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('section.store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <input type="text" name="Name_Section_Ru" class="form-control"
                                                       placeholder="{{ trans('Sections_trans.Section_name_ru') }}">
                                            </div>
