...
return [
    ...
    'Download' => 'تحميل',
    'delete' => 'حذف',
    'prev_grade' => 'المرحلة الدراسية السابقة',
    'prev_class' => 'الصف الدراسي السابق',
    'prev_section' =>'القسم الدراسي السابق',
    'year' => 'السنة الدراسية',
    'curr_grade' =>'المرحلة الدراسية الحالي',
    'curr_year'=>'السنة الدراسية الحالية',
    'curr_class' =>'الصف الدراسي الحالي',
    'curr_section' =>'القسم الدراسي الحالي',
    'ignore_changes' =>'تراجع الكل',
    'sure' =>'هل انت متاك من عملية تراجع كافة الطلاب ؟',
    'undo' =>'ارجاع الطالب',
